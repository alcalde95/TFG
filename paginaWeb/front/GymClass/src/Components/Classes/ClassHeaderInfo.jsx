...
export const ClassHeaderInfo = ({ headerClass }) => {
    return (
        <div className="sm:grid md:grid-cols-5 lg:grid-cols-8 md:place-items-stretch md:justify-between md:items-end w-full flex flex-col flex-wrap gap-2 border-2 rounded-md bg-slate-400 content-center justify-center items-center place-content-center text-center ">
