...
export const LandingPage = () => {
    return (
        <div className="max-w-6xl min-w-80 w-full min-h-screen flex flex-col">
            <header className="grid grid-cols-2 bg-slate-300 border-4 border-teal-500 rounded-md m-2 p-1 text-center">
                <p className="place-self-start">Jorge Alcalde Piñeiro</p>
                <p className="place-self-end ">Jorge Alcalde Piñeiro</p>
            </header>
